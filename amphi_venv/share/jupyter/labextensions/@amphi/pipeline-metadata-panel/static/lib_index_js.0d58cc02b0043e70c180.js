...
/* harmony import */ var _inspectorscripts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./inspectorscripts */ "./lib/inspectorscripts.js");
...
const metadatapanel = {
    ...
    requires: [_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ICommandPalette, _jupyterlab_application__WEBPACK_IMPORTED_MODULE_1__.ILayoutRestorer, _jupyterlab_application__WEBPACK_IMPORTED_MODULE_1__.ILabShell, _jupyterlab_settingregistry__WEBPACK_IMPORTED_MODULE_11__.ISettingRegistry],
    provides: _tokens__WEBPACK_IMPORTED_MODULE_10__.IMetadataPanelManager,
    autoStart: true,
...
const consoles = {
    ...
    requires: [_tokens__WEBPACK_IMPORTED_MODULE_10__.IMetadataPanelManager, _jupyterlab_console__WEBPACK_IMPORTED_MODULE_2__.IConsoleTracker, _jupyterlab_application__WEBPACK_IMPORTED_MODULE_1__.ILabShell],
    autoStart: true,
                ...
                handlers[consolePanel.id] = new Promise((resolve, reject) => {
                    ...
                    const scripts = connector.ready.then(() => {
                        return connector.kernelLanguage.then(lang => {
                            return _inspectorscripts__WEBPACK_IMPORTED_MODULE_6__.Languages.getScript(lang);
                        });
                    });
                    scripts.then((result) => {
...
const pipelines = {
    ...
    requires: [_tokens__WEBPACK_IMPORTED_MODULE_10__.IMetadataPanelManager, _amphi_pipeline_editor__WEBPACK_IMPORTED_MODULE_4__.IPipelineTracker, _jupyterlab_application__WEBPACK_IMPORTED_MODULE_1__.ILabShell, _jupyterlab_settingregistry__WEBPACK_IMPORTED_MODULE_11__.ISettingRegistry],
    autoStart: true,
...
//# sourceMappingURL=lib_index_js.0d58cc02b0043e70c180.js.map