"use strict";
(self["webpackChunk_amphi_pipeline_editor"] = self["webpackChunk_amphi_pipeline_editor"] || []).push([["vendors-node_modules_reactflow_dist_esm_index_mjs"],{
...
/* harmony import */ var zustand_traditional__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! zustand/traditional */ "../../node_modules/zustand/esm/traditional.mjs");
...
function useStore(selector, equalityFn) {
    ...
    return (0,zustand_traditional__WEBPACK_IMPORTED_MODULE_2__.useStoreWithEqualityFn)(store, selector, equalityFn);
}
const useStoreApi = () => {
    const store = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(StoreContext);
    if (store === null) {
...
function Panel({ position, children, className, style, ...rest }) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: (0,classcat__WEBPACK_IMPORTED_MODULE_1__["default"])(['react-flow__panel', className, ...positionClasses]), style: { ...style, pointerEvents }, ...rest }, children));
}
...
function Attribution({ proOptions, position = 'bottom-right' }) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Panel, { position: position, className: "react-flow__attribution", "data-message": "Please only hide this attribution when you are subscribed to React Flow Pro: https://reactflow.dev/pro" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { href: "https://reactflow.dev", target: "_blank", rel: "noopener noreferrer", "aria-label": "React Flow attribution" }, "React Flow")));
}
...
const EdgeText = ({ x, y, label, labelStyle = {}, labelShowBg = true, labelBgStyle = {}, labelBgPadding = [2, 4], labelBgBorderRadius = 2, children, className, ...rest }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("g", { transform: `translate(${x - edgeTextBbox.width / 2} ${y - edgeTextBbox.height / 2})`, className: edgeTextClasses, visibility: edgeTextBbox.width ? 'visible' : 'hidden', ...rest },
        labelShowBg && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("rect", { width: edgeTextBbox.width + 2 * labelBgPadding[0], x: -labelBgPadding[0], y: -labelBgPadding[1], height: edgeTextBbox.height + 2 * labelBgPadding[1], className: "react-flow__edge-textbg", style: labelBgStyle, rx: labelBgBorderRadius, ry: labelBgBorderRadius })),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("text", { className: "react-flow__edge-text", y: edgeTextBbox.height / 2, dy: "0.3em", ref: edgeRef, style: labelStyle }, label),
        children));
};
...
const BaseEdge = ({ id, path, labelX, labelY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style, markerEnd, markerStart, interactionWidth = 20, }) => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", { id: id, style: style, d: path, fill: "none", className: "react-flow__edge-path", markerEnd: markerEnd, markerStart: markerStart }),
        interactionWidth && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", { d: path, fill: "none", strokeOpacity: 0, strokeWidth: interactionWidth, className: "react-flow__edge-interaction" })),
        label && isNumeric(labelX) && isNumeric(labelY) ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(EdgeText$1, { x: labelX, y: labelY, label: label, labelStyle: labelStyle, labelShowBg: labelShowBg, labelBgStyle: labelBgStyle, labelBgPadding: labelBgPadding, labelBgBorderRadius: labelBgBorderRadius })) : null));
};
...
const SimpleBezierEdge = (0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(({ sourceX, sourceY, targetX, targetY, sourcePosition = Position.Bottom, targetPosition = Position.Top, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style, markerEnd, markerStart, interactionWidth, }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(BaseEdge, { path: path, labelX: labelX, labelY: labelY, label: label, labelStyle: labelStyle, labelShowBg: labelShowBg, labelBgStyle: labelBgStyle, labelBgPadding: labelBgPadding, labelBgBorderRadius: labelBgBorderRadius, style: style, markerEnd: markerEnd, markerStart: markerStart, interactionWidth: interactionWidth }));
});
...
const StepEdge = (0,react__WEBPACK_IMPORTED_MODULE_0__.memo)((props) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(SmoothStepEdge, { ...props, pathOptions: (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => ({ borderRadius: 0, offset: props.pathOptions?.offset }), [props.pathOptions?.offset]) })));
...
const Handle = (0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(({ type = 'source', position = Position.Top, isValidConnection, isConnectable = true, isConnectableStart = true, isConnectableEnd = true, id, onConnect, children, className, onMouseDown, onTouchStart, ...rest }, ref) => {
    ...
    const { connectOnClick, noPanClassName } = useStore(selector$f, zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
    const { connecting, clickConnecting } = useStore(connectingSelector(nodeId, handleId, type), zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
    if (!nodeId) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { "data-handleid": handleId, "data-nodeid": nodeId, "data-handlepos": position, "data-id": `${nodeId}-${handleId}-${type}`, className: (0,classcat__WEBPACK_IMPORTED_MODULE_1__["default"])([
            'react-flow__handle',
...
const DefaultNode = ({ data, isConnectable, targetPosition = Position.Top, sourcePosition = Position.Bottom, }) => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Handle$1, { type: "target", position: targetPosition, isConnectable: isConnectable }),
        data?.label,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Handle$1, { type: "source", position: sourcePosition, isConnectable: isConnectable })));
};
DefaultNode.displayName = 'DefaultNode';
var DefaultNode$1 = (0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(DefaultNode);

const InputNode = ({ data, isConnectable, sourcePosition = Position.Bottom }) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
    data?.label,
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Handle$1, { type: "source", position: sourcePosition, isConnectable: isConnectable })));
InputNode.displayName = 'InputNode';
var InputNode$1 = (0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(InputNode);

const OutputNode = ({ data, isConnectable, targetPosition = Position.Top }) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Handle$1, { type: "target", position: targetPosition, isConnectable: isConnectable }),
    data?.label));
...
function areEqual(a, b) {
    return ((0,zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow)(a.selectedNodes.map(selectId), b.selectedNodes.map(selectId)) &&
        (0,zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow)(a.selectedEdges.map(selectId), b.selectedEdges.map(selectId)));
}
...
function Wrapper$1({ onSelectionChange }) {
    ...
    if (onSelectionChange || storeHasSelectionChange) {
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(SelectionListener, { onSelectionChange: onSelectionChange });
    }
    return null;
}
...
const StoreUpdater = ({ nodes, edges, defaultNodes, defaultEdges, onConnect, onConnectStart, onConnectEnd, onClickConnectStart, onClickConnectEnd, nodesDraggable, nodesConnectable, nodesFocusable, edgesFocusable, edgesUpdatable, elevateNodesOnSelect, minZoom, maxZoom, nodeExtent, onNodesChange, onEdgesChange, elementsSelectable, connectionMode, snapGrid, snapToGrid, translateExtent, connectOnClick, defaultEdgeOptions, fitView, fitViewOptions, onNodesDelete, onEdgesDelete, onNodeDrag, onNodeDragStart, onNodeDragStop, onSelectionDrag, onSelectionDragStart, onSelectionDragStop, noPanClassName, nodeOrigin, rfId, autoPanOnConnect, autoPanOnNodeDrag, onError, connectionRadius, isValidConnection, nodeDragThreshold, }) => {
    const { setNodes, setEdges, setDefaultNodesAndEdges, setMinZoom, setMaxZoom, setTranslateExtent, setNodeExtent, reset, } = useStore(selector$d, zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
    const store = useStoreApi();
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
...
function AriaLiveMessage({ rfId }) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { id: `${ARIA_LIVE_MESSAGE}-${rfId}`, "aria-live": "assertive", "aria-atomic": "true", style: ariaLiveStyle }, ariaLiveMessage));
}
function A11yDescriptions({ rfId, disableKeyboardA11y }) {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { id: `${ARIA_NODE_DESC_KEY}-${rfId}`, style: style },
            "Press enter or space to select a node.",
            !disableKeyboardA11y && 'You can then use the arrow keys to move the node around.',
            " Press delete to remove it and escape to cancel.",
            ' '),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { id: `${ARIA_EDGE_DESC_KEY}-${rfId}`, style: style }, "Press enter or space to select an edge. You can then press delete to remove it or escape to cancel."),
        !disableKeyboardA11y && react__WEBPACK_IMPORTED_MODULE_0___default().createElement(AriaLiveMessage, { rfId: rfId })));
}
...
function fitView(get, options = {}) {
    ...
    if (d3initialized && (isInitialFitView || !options.initial)) {
        ...
        if (nodes.length > 0 && nodesInitialized) {
            ...
            const nextTransform = d3_zoom__WEBPACK_IMPORTED_MODULE_4__.zoomIdentity.translate(x, y).scale(zoom);
...
const useViewportHelper = () => {
    const store = useStoreApi();
    const { d3Zoom, d3Selection } = useStore(selector$b, zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
        ...
        if (d3Selection && d3Zoom) {
            return {
                ...
                setViewport: (transform, options) => {
                    ...
                    const nextTransform = d3_zoom__WEBPACK_IMPORTED_MODULE_4__.zoomIdentity
                ...
                setCenter: (x, y, options) => {
                    ...
                    const transform = d3_zoom__WEBPACK_IMPORTED_MODULE_4__.zoomIdentity.translate(centerX, centerY).scale(nextZoom);
                    d3Zoom.transform(getD3Transition(d3Selection, options?.duration), transform);
                },
                fitBounds: (bounds, options) => {
                    const { width, height, minZoom, maxZoom } = store.getState();
                    const { x, y, zoom } = getViewportForBounds(bounds, width, height, minZoom, maxZoom, options?.padding ?? 0.1);
                    const transform = d3_zoom__WEBPACK_IMPORTED_MODULE_4__.zoomIdentity.translate(x, y).scale(zoom);
                    d3Zoom.transform(getD3Transition(d3Selection, options?.duration), transform);
                },
...
const ZoomPane = ({ onMove, onMoveStart, onMoveEnd, onPaneContextMenu, zoomOnScroll = true, zoomOnPinch = true, panOnScroll = false, panOnScrollSpeed = 0.5, panOnScrollMode = PanOnScrollMode.Free, zoomOnDoubleClick = true, elementsSelectable, panOnDrag = true, defaultViewport, translateExtent, minZoom, maxZoom, zoomActivationKeyCode, preventScrolling = true, children, noWheelClassName, noPanClassName, }) => {
    ...
    const { d3Zoom, d3Selection, d3ZoomHandler, userSelectionActive } = useStore(selector$a, zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        if (zoomPane.current) {
            ...
            const d3ZoomInstance = (0,d3_zoom__WEBPACK_IMPORTED_MODULE_4__.zoom)().scaleExtent([minZoom, maxZoom]).translateExtent(translateExtent);
            const selection = (0,d3_selection__WEBPACK_IMPORTED_MODULE_6__["default"])(zoomPane.current).call(d3ZoomInstance);
            const updatedTransform = d3_zoom__WEBPACK_IMPORTED_MODULE_4__.zoomIdentity
            ...
            if (panOnScroll && !zoomActivationKeyPressed && !userSelectionActive) {
                d3Selection.on('wheel.zoom', (event) => {
                    ...
                    if (event.ctrlKey && zoomOnPinch) {
                        const point = (0,d3_selection__WEBPACK_IMPORTED_MODULE_5__["default"])(event);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "react-flow__renderer", ref: zoomPane, style: containerStyle }, children));
};
...
function UserSelection() {
    const { userSelectionActive, userSelectionRect } = useStore(selector$9, zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
    const isActive = userSelectionActive && userSelectionRect;
    if (!isActive) {
        return null;
    }
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "react-flow__selection react-flow__container", style: {
...
const Pane = (0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(({ isSelecting, selectionMode = SelectionMode.Full, panOnDrag, onSelectionStart, onSelectionEnd, onPaneClick, onPaneContextMenu, onPaneScroll, onPaneMouseEnter, onPaneMouseMove, onPaneMouseLeave, children, }) => {
    ...
    const { userSelectionActive, elementsSelectable, dragging } = useStore(selector$8, zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: (0,classcat__WEBPACK_IMPORTED_MODULE_1__["default"])(['react-flow__pane', { dragging, selection: isSelecting }]), onClick: hasActiveSelection ? undefined : wrapHandler(onClick, container), onContextMenu: wrapHandler(onContextMenu, container), onWheel: wrapHandler(onWheel, container), onMouseEnter: hasActiveSelection ? undefined : onPaneMouseEnter, onMouseDown: hasActiveSelection ? onMouseDown : undefined, onMouseMove: hasActiveSelection ? onMouseMove : onPaneMouseMove, onMouseUp: hasActiveSelection ? onMouseUp : undefined, onMouseLeave: hasActiveSelection ? onMouseLeave : onPaneMouseLeave, ref: container, style: containerStyle },
        children,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(UserSelection, null)));
});
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        if (nodeRef?.current) {
            ...
            if (disabled) {
                ...
                const dragHandler = (0,d3_drag__WEBPACK_IMPORTED_MODULE_7__["default"])()
                    .on('start', (event) => {
...
var wrapNode = (NodeComponent) => {
    const NodeWrapper = ({ id, type, data, xPos, yPos, xPosOrigin, yPosOrigin, selected, onClick, onMouseEnter, onMouseMove, onMouseLeave, onContextMenu, onDoubleClick, style, className, isDraggable, isSelectable, isConnectable, isFocusable, selectNodesOnDrag, sourcePosition, targetPosition, hidden, resizeObserver, dragHandle, zIndex, isParent, noDragClassName, noPanClassName, initialized, disableKeyboardA11y, ariaLabel, rfId, hasHandleBounds, }) => {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: (0,classcat__WEBPACK_IMPORTED_MODULE_1__["default"])([
                'react-flow__node',
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Provider, { value: id },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(NodeComponent, { id: id, data: data, type: type, xPos: xPos, yPos: yPos, selected: selected, isConnectable: isConnectable, sourcePosition: sourcePosition, targetPosition: targetPosition, dragging: dragging, dragHandle: dragHandle, zIndex: zIndex }))));
    };
...
function NodesSelection({ onSelectionContextMenu, noPanClassName, disableKeyboardA11y }) {
    const store = useStoreApi();
    const { width, height, x: left, y: top, transformString, userSelectionActive } = useStore(selector$7, zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
    const updatePositions = useUpdateNodePositions();
    const nodeRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        if (!disableKeyboardA11y) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: (0,classcat__WEBPACK_IMPORTED_MODULE_1__["default"])(['react-flow__nodesselection', 'react-flow__container', noPanClassName]), style: {
            transform: transformString,
        } },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { ref: nodeRef, className: "react-flow__nodesselection-rect", onContextMenu: onContextMenu, tabIndex: disableKeyboardA11y ? undefined : -1, onKeyDown: disableKeyboardA11y ? undefined : onKeyDown, style: {
                width,
                height,
                top,
                left,
...
const FlowRenderer = ({ children, onPaneClick, onPaneMouseEnter, onPaneMouseMove, onPaneMouseLeave, onPaneContextMenu, onPaneScroll, deleteKeyCode, onMove, onMoveStart, onMoveEnd, selectionKeyCode, selectionOnDrag, selectionMode, onSelectionStart, onSelectionEnd, multiSelectionKeyCode, panActivationKeyCode, zoomActivationKeyCode, elementsSelectable, zoomOnScroll, zoomOnPinch, panOnScroll: _panOnScroll, panOnScrollSpeed, panOnScrollMode, zoomOnDoubleClick, panOnDrag: _panOnDrag, defaultViewport, translateExtent, minZoom, maxZoom, preventScrolling, onSelectionContextMenu, noWheelClassName, noPanClassName, disableKeyboardA11y, }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ZoomPane, { onMove: onMove, onMoveStart: onMoveStart, onMoveEnd: onMoveEnd, onPaneContextMenu: onPaneContextMenu, elementsSelectable: elementsSelectable, zoomOnScroll: zoomOnScroll, zoomOnPinch: zoomOnPinch, panOnScroll: panOnScroll, panOnScrollSpeed: panOnScrollSpeed, panOnScrollMode: panOnScrollMode, zoomOnDoubleClick: zoomOnDoubleClick, panOnDrag: !selectionKeyPressed && panOnDrag, defaultViewport: defaultViewport, translateExtent: translateExtent, minZoom: minZoom, maxZoom: maxZoom, zoomActivationKeyCode: zoomActivationKeyCode, preventScrolling: preventScrolling, noWheelClassName: noWheelClassName, noPanClassName: noPanClassName },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Pane, { onSelectionStart: onSelectionStart, onSelectionEnd: onSelectionEnd, onPaneClick: onPaneClick, onPaneMouseEnter: onPaneMouseEnter, onPaneMouseMove: onPaneMouseMove, onPaneMouseLeave: onPaneMouseLeave, onPaneContextMenu: onPaneContextMenu, onPaneScroll: onPaneScroll, panOnDrag: panOnDrag, isSelecting: !!isSelecting, selectionMode: selectionMode },
            children,
            nodesSelectionActive && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(NodesSelection$1, { onSelectionContextMenu: onSelectionContextMenu, noPanClassName: noPanClassName, disableKeyboardA11y: disableKeyboardA11y })))));
};
...
const NodeRenderer = (props) => {
    const { nodesDraggable, nodesConnectable, nodesFocusable, elementsSelectable, updateNodeDimensions, onError } = useStore(selector$5, zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "react-flow__nodes", style: containerStyle }, nodes.map((node) => {
...
var wrapEdge = (EdgeComponent) => {
    const EdgeWrapper = ({ id, className, type, data, onClick, onEdgeDoubleClick, selected, animated, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style, source, target, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, elementsSelectable, hidden, sourceHandleId, targetHandleId, onContextMenu, onMouseEnter, onMouseMove, onMouseLeave, reconnectRadius, onReconnect, onReconnectStart, onReconnectEnd, markerEnd, markerStart, rfId, ariaLabel, isFocusable, isReconnectable, pathOptions, interactionWidth, disableKeyboardA11y, }) => {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("g", { className: (0,classcat__WEBPACK_IMPORTED_MODULE_1__["default"])([
                'react-flow__edge',
...
const ArrowSymbol = ({ color = 'none', strokeWidth = 1 }) => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("polyline", { style: {
            stroke: color,
            strokeWidth,
...
const Marker = ({ id, type, color, width = 12.5, height = 12.5, markerUnits = 'strokeWidth', strokeWidth, orient = 'auto-start-reverse', }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("marker", { className: "react-flow__arrowhead", id: id, markerWidth: `${width}`, markerHeight: `${height}`, viewBox: "-10 -10 20 20", markerUnits: markerUnits, orient: orient, refX: "0", refY: "0" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Symbol, { color: color, strokeWidth: strokeWidth })));
};
...
const MarkerDefinitions = ({ defaultColor, rfId }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("defs", null, markers.map((marker) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Marker, { id: marker.id, key: marker.id, type: marker.type, color: marker.color, width: marker.width, height: marker.height, markerUnits: marker.markerUnits, strokeWidth: marker.strokeWidth, orient: marker.orient })))));
};
...
const EdgeRenderer = ({ defaultMarkerColor, onlyRenderVisibleElements, elevateEdgesOnSelect, rfId, edgeTypes, noPanClassName, onEdgeContextMenu, onEdgeMouseEnter, onEdgeMouseMove, onEdgeMouseLeave, onEdgeClick, onEdgeDoubleClick, onReconnect, onReconnectStart, onReconnectEnd, reconnectRadius, children, disableKeyboardA11y, }) => {
    const { edgesFocusable, edgesUpdatable, elementsSelectable, width, height, connectionMode, nodeInternals, onError } = useStore(selector$4, zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
    const edgeTree = useVisibleEdges(onlyRenderVisibleElements, nodeInternals, elevateEdgesOnSelect);
    if (!width) {
        return null;
    }
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        edgeTree.map(({ level, edges, isMaxLevel }) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { key: level, style: { zIndex: level }, width: width, height: height, className: "react-flow__edges react-flow__container" },
            isMaxLevel && react__WEBPACK_IMPORTED_MODULE_0___default().createElement(MarkerDefinitions$1, { defaultColor: defaultMarkerColor, rfId: rfId }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("g", null, edges.map((edge) => {
...
function Viewport({ children }) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "react-flow__viewport react-flow__container", style: { transform } }, children));
}
...
const ConnectionLine = ({ nodeId, handleType, style, type = ConnectionLineType.Bezier, CustomComponent, connectionStatus, }) => {
    const { fromNode, handleId, toX, toY, connectionMode } = useStore((0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((s) => ({
        ...
        connectionMode: s.connectionMode,
    }), [nodeId]), zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
    ...
    if (CustomComponent) {
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(CustomComponent, { connectionLineType: type, connectionLineStyle: style, fromNode: fromNode, fromHandle: fromHandle, fromX: fromX, fromY: fromY, toX: toX, toY: toY, fromPosition: fromPosition, toPosition: toPosition, connectionStatus: connectionStatus }));
    }
    let dAttr = '';
    const pathParams = {
        sourceX: fromX,
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", { d: dAttr, fill: "none", className: "react-flow__connection-path", style: style });
};
...
function ConnectionLineWrapper({ containerStyle, style, type, component }) {
    const { nodeId, handleType, nodesConnectable, width, height, connectionStatus } = useStore(selector$2, zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
    const isValid = !!(nodeId && handleType && width && nodesConnectable);
    if (!isValid) {
        return null;
    }
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { style: containerStyle, width: width, height: height, className: "react-flow__edges react-flow__connectionline react-flow__container" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("g", { className: (0,classcat__WEBPACK_IMPORTED_MODULE_1__["default"])(['react-flow__connection', connectionStatus]) },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ConnectionLine, { nodeId: nodeId, handleType: handleType, style: style, type: type, CustomComponent: component, connectionStatus: connectionStatus }))));
}
...
function useNodeOrEdgeTypes(nodeOrEdgeTypes, createTypes) {
    ...
    const typesParsed = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
        if (true) {
            ...
            if ((0,zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow)(typesKeysRef.current, typeKeys)) {
...
const createRFStore = () => (0,zustand_traditional__WEBPACK_IMPORTED_MODULE_2__.createWithEqualityFn)((set, get) => ({
    ...initialState,
    setNodes: (nodes) => {
...
const ReactFlowProvider = ({ children }) => {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Provider$1, { value: storeRef.current }, children);
};
...
const Wrapper = ({ children }) => {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ReactFlowProvider, null, children);
};
...
function EdgeLabelRenderer({ children }) {
    ...
    return (0,react_dom__WEBPACK_IMPORTED_MODULE_8__.createPortal)(children, edgeLabelRenderer);
}
...
function useNodes() {
    const nodes = useStore(nodesSelector, zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
    return nodes;
}

const edgesSelector = (state) => state.edges;
function useEdges() {
    const edges = useStore(edgesSelector, zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
    return edges;
}
...
function useViewport() {
    const viewport = useStore(viewportSelector, zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
    return viewport;
}
...
/* harmony import */ var _noevent_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./noevent.js */ "../../node_modules/d3-drag/src/noevent.js");
/* harmony import */ var _constant_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./constant.js */ "../../node_modules/d3-drag/src/constant.js");
/* harmony import */ var _event_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./event.js */ "../../node_modules/d3-drag/src/event.js");
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  function drag(selection) {
    selection
      ...
      .filter(touchable)
        ...
        .on("touchmove.drag", touchmoved, _noevent_js__WEBPACK_IMPORTED_MODULE_4__.nonpassive)
  ...
  function mousedowned(event, d) {
    ...
    (0,d3_selection__WEBPACK_IMPORTED_MODULE_2__["default"])(event.view)
      .on("mousemove.drag", mousemoved, _noevent_js__WEBPACK_IMPORTED_MODULE_4__.nonpassivecapture)
      .on("mouseup.drag", mouseupped, _noevent_js__WEBPACK_IMPORTED_MODULE_4__.nonpassivecapture);
  ...
  function beforestart(that, container, event, d, identifier, touch) {
    var dispatch = listeners.copy(),
        p = (0,d3_selection__WEBPACK_IMPORTED_MODULE_1__["default"])(touch || event, container), dx, dy,
        s;

    if ((s = subject.call(that, new _event_js__WEBPACK_IMPORTED_MODULE_6__["default"]("beforestart", {
        sourceEvent: event,
        target: drag,
        identifier,
        active,
    ...
    return function gesture(type, event, touch) {
      ...
      switch (type) {
        ...
        case "drag": p = (0,d3_selection__WEBPACK_IMPORTED_MODULE_1__["default"])(touch || event, container), n = active; break;
      }
      dispatch.call(
        type,
        that,
...
const { useDebugValue } = (react__WEBPACK_IMPORTED_MODULE_0___default());
...
function LinePattern({ color, dimensions, lineWidth }) {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", { stroke: color, strokeWidth: lineWidth, d: `M${dimensions[0] / 2} 0 V${dimensions[1]} M0 ${dimensions[1] / 2} H${dimensions[0]}` }));
}
function DotPattern({ color, radius }) {
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("circle", { cx: radius, cy: radius, r: radius, fill: color });
}
...
size, lineWidth = 1, offset = 2, color, style, className, }) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { className: (0,classcat__WEBPACK_IMPORTED_MODULE_1__["default"])(['react-flow__background', className]), style: {
            ...style,
            position: 'absolute',
            width: '100%',
            height: '100%',
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("pattern", { id: patternId + id, x: transform[0] % scaledGap[0], y: transform[1] % scaledGap[1], width: scaledGap[0], height: scaledGap[1], patternUnits: "userSpaceOnUse", patternTransform: `translate(-${patternOffset[0]},-${patternOffset[1]})` }, isDots ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(DotPattern, { color: patternColor, radius: scaledSize / offset })) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(LinePattern, { dimensions: patternDimensions, color: patternColor, lineWidth: lineWidth }))),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: `url(#${patternId + id})` })));
}
...
/* harmony import */ var _reactflow_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @reactflow/core */ "../../node_modules/@reactflow/core/dist/esm/index.mjs");
...
function PlusIcon() {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 32" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", { d: "M32 18.133H18.133V32h-4.266V18.133H0v-4.266h13.867V0h4.266v13.867H32z" })));
}

function MinusIcon() {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 5" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", { d: "M0 0h32v4.2H0z" })));
}

function FitViewIcon() {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 30" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", { d: "M3.692 4.63c0-.53.4-.938.939-.938h5.215V0H4.708C2.13 0 0 2.054 0 4.63v5.216h3.692V4.631zM27.354 0h-5.2v3.692h5.17c.53 0 .984.4.984.939v5.215H32V4.631A4.624 4.624 0 0027.354 0zm.954 24.83c0 .532-.4.94-.939.94h-5.215v3.768h5.215c2.577 0 4.631-2.13 4.631-4.707v-5.139h-3.692v5.139zm-23.677.94c-.531 0-.939-.4-.939-.94v-5.138H0v5.139c0 2.577 2.13 4.707 4.708 4.707h5.138V25.77H4.631z" })));
}

function LockIcon() {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 25 32" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", { d: "M21.333 10.667H19.81V7.619C19.81 3.429 16.38 0 12.19 0 8 0 4.571 3.429 4.571 7.619v3.048H3.048A3.056 3.056 0 000 13.714v15.238A3.056 3.056 0 003.048 32h18.285a3.056 3.056 0 003.048-3.048V13.714a3.056 3.056 0 00-3.048-3.047zM12.19 24.533a3.056 3.056 0 01-3.047-3.047 3.056 3.056 0 013.047-3.048 3.056 3.056 0 013.048 3.048 3.056 3.056 0 01-3.048 3.047zm4.724-13.866H7.467V7.619c0-2.59 2.133-4.724 4.723-4.724 2.591 0 4.724 2.133 4.724 4.724v3.048z" })));
}

function UnlockIcon() {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 25 32" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", { d: "M21.333 10.667H19.81V7.619C19.81 3.429 16.38 0 12.19 0c-4.114 1.828-1.37 2.133.305 2.438 1.676.305 4.42 2.59 4.42 5.181v3.048H3.047A3.056 3.056 0 000 13.714v15.238A3.056 3.056 0 003.048 32h18.285a3.056 3.056 0 003.048-3.048V13.714a3.056 3.056 0 00-3.048-3.047zM12.19 24.533a3.056 3.056 0 01-3.047-3.047 3.056 3.056 0 013.047-3.048 3.056 3.056 0 013.048 3.048 3.056 3.056 0 01-3.048 3.047z" })));
}

const ControlButton = ({ children, className, ...rest }) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { type: "button", className: (0,classcat__WEBPACK_IMPORTED_MODULE_1__["default"])(['react-flow__controls-button', className]), ...rest }, children));
...
const Controls = ({ style, showZoom = true, showFitView = true, showInteractive = true, fitViewOptions, onZoomIn, onZoomOut, onFitView, onInteractiveChange, className, children, position = 'bottom-left', }) => {
    ...
    const { isInteractive, minZoomReached, maxZoomReached } = (0,_reactflow_core__WEBPACK_IMPORTED_MODULE_3__.useStore)(selector, zustand_shallow__WEBPACK_IMPORTED_MODULE_2__.shallow);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_reactflow_core__WEBPACK_IMPORTED_MODULE_3__.Panel, { className: (0,classcat__WEBPACK_IMPORTED_MODULE_1__["default"])(['react-flow__controls', className]), position: position, style: style, "data-testid": "rf__controls" },
        showZoom && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ControlButton, { onClick: onZoomInHandler, className: "react-flow__controls-zoomin", title: "zoom in", "aria-label": "zoom in", disabled: maxZoomReached },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(PlusIcon, null)),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ControlButton, { onClick: onZoomOutHandler, className: "react-flow__controls-zoomout", title: "zoom out", "aria-label": "zoom out", disabled: minZoomReached },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(MinusIcon, null)))),
        showFitView && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ControlButton, { className: "react-flow__controls-fitview", onClick: onFitViewHandler, title: "fit view", "aria-label": "fit view" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(FitViewIcon, null))),
        showInteractive && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ControlButton, { className: "react-flow__controls-interactive", onClick: onToggleInteractivity, title: "toggle interactivity", "aria-label": "toggle interactivity" }, isInteractive ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(UnlockIcon, null) : react__WEBPACK_IMPORTED_MODULE_0___default().createElement(LockIcon, null))),
        children));
};
...
/* harmony import */ var _reactflow_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @reactflow/core */ "../../node_modules/@reactflow/core/dist/esm/index.mjs");
...
const MiniMapNode = ({ id, x, y, width, height, style, color, strokeColor, strokeWidth, className, borderRadius, shapeRendering, onClick, selected, }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("rect", { className: (0,classcat__WEBPACK_IMPORTED_MODULE_1__["default"])(['react-flow__minimap-node', { selected }, className]), x: x, y: y, rx: borderRadius, ry: borderRadius, width: width, height: height, fill: fill, stroke: strokeColor, strokeWidth: strokeWidth, shapeRendering: shapeRendering, onClick: onClick ? (event) => onClick(event, id) : undefined }));
};
...
nodeComponent: NodeComponent = MiniMapNode$1, onClick, }) {
    const nodes = (0,_reactflow_core__WEBPACK_IMPORTED_MODULE_6__.useStore)(selectorNodes, zustand_shallow__WEBPACK_IMPORTED_MODULE_2__.shallow);
    const nodeOrigin = (0,_reactflow_core__WEBPACK_IMPORTED_MODULE_6__.useStore)(selector$1);
    const nodeColorFunc = getAttrFunction(nodeColor);
    const nodeStrokeColorFunc = getAttrFunction(nodeStrokeColor);
    const nodeClassNameFunc = getAttrFunction(nodeClassName);
    const shapeRendering = typeof window === 'undefined' || !!window.chrome ? 'crispEdges' : 'geometricPrecision';
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, nodes.map((node) => {
        const { x, y } = (0,_reactflow_core__WEBPACK_IMPORTED_MODULE_6__.getNodePositionWithOrigin)(node, nodeOrigin).positionAbsolute;
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(NodeComponent, { key: node.id, x: x, y: y, width: node.width, height: node.height, style: node.style, selected: node.selected, className: nodeClassNameFunc(node), color: nodeColorFunc(node), borderRadius: nodeBorderRadius, strokeColor: nodeStrokeColorFunc(node), strokeWidth: nodeStrokeWidth, shapeRendering: shapeRendering, onClick: onClick, id: node.id }));
    })));
}
...
const selector = (s) => {
    ...
    return {
        viewBB,
        boundingRect: nodes.length > 0 ? (0,_reactflow_core__WEBPACK_IMPORTED_MODULE_6__.getBoundsOfRects)((0,_reactflow_core__WEBPACK_IMPORTED_MODULE_6__.getNodesBounds)(nodes, s.nodeOrigin), viewBB) : viewBB,
        rfId: s.rfId,
    };
};
...
nodeComponent, maskColor = 'rgb(240, 240, 240, 0.6)', maskStrokeColor = 'none', maskStrokeWidth = 1, position = 'bottom-right', onClick, onNodeClick, pannable = false, zoomable = false, ariaLabel = 'React Flow mini map', inversePan = false, zoomStep = 10, offsetScale = 5, }) {
    const store = (0,_reactflow_core__WEBPACK_IMPORTED_MODULE_6__.useStoreApi)();
    const svg = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
    const { boundingRect, viewBB, rfId } = (0,_reactflow_core__WEBPACK_IMPORTED_MODULE_6__.useStore)(selector, zustand_shallow__WEBPACK_IMPORTED_MODULE_2__.shallow);
    ...
    const onSvgClick = onClick
        ? (event) => {
            const rfCoord = (0,d3_selection__WEBPACK_IMPORTED_MODULE_4__["default"])(event);
    ...
    const onSvgNodeClick = onNodeClick
        ...
        : undefined;
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_reactflow_core__WEBPACK_IMPORTED_MODULE_6__.Panel, { position: position, style: style, className: (0,classcat__WEBPACK_IMPORTED_MODULE_1__["default"])(['react-flow__minimap', className]), "data-testid": "rf__minimap" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { width: elementWidth, height: elementHeight, viewBox: `${x} ${y} ${width} ${height}`, role: "img", "aria-labelledby": labelledBy, ref: svg, onClick: onSvgClick },
            ariaLabel && react__WEBPACK_IMPORTED_MODULE_0___default().createElement("title", { id: labelledBy }, ariaLabel),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(MiniMapNodes$1, { onClick: onSvgNodeClick, nodeColor: nodeColor, nodeStrokeColor: nodeStrokeColor, nodeBorderRadius: nodeBorderRadius, nodeClassName: nodeClassName, nodeStrokeWidth: nodeStrokeWidth, nodeComponent: nodeComponent }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path", { className: "react-flow__minimap-mask", d: `M${x - offset},${y - offset}h${width + offset * 2}v${height + offset * 2}h${-width - offset * 2}z
...
/* harmony import */ var _reactflow_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @reactflow/core */ "../../node_modules/@reactflow/core/dist/esm/index.mjs");
...
function ResizeControl({ nodeId, position, variant = ResizeControlVariant.Handle, className, style = {}, children, color, minWidth = 10, minHeight = 10, maxWidth = Number.MAX_VALUE, maxHeight = Number.MAX_VALUE, keepAspectRatio = false, shouldResize, onResizeStart, onResize, onResizeEnd, }) {
    ...
    const getPointerPosition = (0,_reactflow_core__WEBPACK_IMPORTED_MODULE_4__.useGetPointerPosition)();
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        ...
        const dragHandler = (0,d3_drag__WEBPACK_IMPORTED_MODULE_2__["default"])()
            ...
            if (node) {
                ...
                let width = (0,_reactflow_core__WEBPACK_IMPORTED_MODULE_4__.clamp)(startWidth + (invertX ? -distX : distX), minWidth, maxWidth);
                let height = (0,_reactflow_core__WEBPACK_IMPORTED_MODULE_4__.clamp)(startHeight + (invertY ? -distY : distY), minHeight, maxHeight);
                if (keepAspectRatio) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: (0,classcat__WEBPACK_IMPORTED_MODULE_1__["default"])(['react-flow__resize-control', 'nodrag', ...positionClassNames, variant, className]), ref: resizeControlRef, style: controlStyle }, children));
}
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _reactflow_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @reactflow/core */ "../../node_modules/@reactflow/core/dist/esm/index.mjs");
...
function NodeToolbarPortal({ children }) {
    const wrapperRef = (0,_reactflow_core__WEBPACK_IMPORTED_MODULE_1__.useStore)(selector);
    if (!wrapperRef) {
        return null;
    }
    return (0,react_dom__WEBPACK_IMPORTED_MODULE_4__.createPortal)(children, wrapperRef);
}
...
const nodeEqualityFn = (a, b) => a?.positionAbsolute?.x === b?.positionAbsolute?.x &&
    ...
    a?.[_reactflow_core__WEBPACK_IMPORTED_MODULE_1__.internalsSymbol]?.z === b?.[_reactflow_core__WEBPACK_IMPORTED_MODULE_1__.internalsSymbol]?.z;
...
function getTransform(nodeRect, transform, position, offset, align) {
    ...
    switch (position) {
        case _reactflow_core__WEBPACK_IMPORTED_MODULE_1__.Position.Right:
            pos = [
            ...
            break;
        case _reactflow_core__WEBPACK_IMPORTED_MODULE_1__.Position.Bottom:
            pos[1] = (nodeRect.y + nodeRect.height) * transform[2] + transform[1] + offset;
            shift[1] = 0;
            break;
        case _reactflow_core__WEBPACK_IMPORTED_MODULE_1__.Position.Left:
            pos = [
...
function NodeToolbar({ nodeId, children, className, style, isVisible, position = _reactflow_core__WEBPACK_IMPORTED_MODULE_1__.Position.Top, offset = 10, align = 'center', ...rest }) {
    const contextNodeId = (0,_reactflow_core__WEBPACK_IMPORTED_MODULE_1__.useNodeId)();
    ...
    const nodes = (0,_reactflow_core__WEBPACK_IMPORTED_MODULE_1__.useStore)(nodesSelector, nodesEqualityFn);
    const { transform, nodeOrigin, selectedNodesCount } = (0,_reactflow_core__WEBPACK_IMPORTED_MODULE_1__.useStore)(storeSelector, zustand_shallow__WEBPACK_IMPORTED_MODULE_3__.shallow);
    const isActive = typeof isVisible === 'boolean' ? isVisible : nodes.length === 1 && nodes[0].selected && selectedNodesCount === 1;
    if (!isActive || !nodes.length) {
        return null;
    }
    const nodeRect = (0,_reactflow_core__WEBPACK_IMPORTED_MODULE_1__.getNodesBounds)(nodes, nodeOrigin);
    const zIndex = Math.max(...nodes.map((node) => (node[_reactflow_core__WEBPACK_IMPORTED_MODULE_1__.internalsSymbol]?.z || 1) + 1));
    const wrapperStyle = {
        position: 'absolute',
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(NodeToolbarPortal, null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: wrapperStyle, className: (0,classcat__WEBPACK_IMPORTED_MODULE_2__["default"])(['react-flow__node-toolbar', className]), ...rest }, children)));
}
...
/* harmony export */   getNodesBounds: () => (/* reexport safe */ _reactflow_core__WEBPACK_IMPORTED_MODULE_0__.getNodesBounds),
...
/* harmony export */   getViewportForBounds: () => (/* reexport safe */ _reactflow_core__WEBPACK_IMPORTED_MODULE_0__.getViewportForBounds),
/* harmony export */   handleParentExpand: () => (/* reexport safe */ _reactflow_core__WEBPACK_IMPORTED_MODULE_0__.handleParentExpand),
...
/* harmony export */   reconnectEdge: () => (/* reexport safe */ _reactflow_core__WEBPACK_IMPORTED_MODULE_0__.reconnectEdge),
...
/* harmony export */ });
/* harmony import */ var _reactflow_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @reactflow/core */ "../../node_modules/@reactflow/core/dist/esm/index.mjs");
/* harmony import */ var _reactflow_minimap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @reactflow/minimap */ "./node_modules/@reactflow/minimap/dist/esm/index.mjs");
/* harmony import */ var _reactflow_controls__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @reactflow/controls */ "./node_modules/@reactflow/controls/dist/esm/index.mjs");
/* harmony import */ var _reactflow_background__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @reactflow/background */ "./node_modules/@reactflow/background/dist/esm/index.mjs");
/* harmony import */ var _reactflow_node_toolbar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @reactflow/node-toolbar */ "./node_modules/@reactflow/node-toolbar/dist/esm/index.mjs");
/* harmony import */ var _reactflow_node_resizer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @reactflow/node-resizer */ "./node_modules/@reactflow/node-resizer/dist/esm/index.mjs");
...
//# sourceMappingURL=vendors-node_modules_reactflow_dist_esm_index_mjs.e2fa5953cb62f0f11494.js.map