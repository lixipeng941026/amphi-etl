"use strict";
(self["webpackChunk_amphi_pipeline_log_console"] = self["webpackChunk_amphi_pipeline_log_console"] || []).push([["node_modules_glideapps_glide-data-grid_dist_esm_internal_data-grid-overlay-editor_data-grid-o-c9572e"],{
...
/* harmony import */ var _click_outside_container_click_outside_container_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../click-outside-container/click-outside-container.js */ "../../node_modules/@glideapps/glide-data-grid/dist/esm/internal/click-outside-container/click-outside-container.js");
/* harmony import */ var _common_styles_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../common/styles.js */ "../../node_modules/@glideapps/glide-data-grid/dist/esm/common/styles.js");
/* harmony import */ var _data_grid_data_grid_types_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../data-grid/data-grid-types.js */ "../../node_modules/@glideapps/glide-data-grid/dist/esm/internal/data-grid/data-grid-types.js");
/* harmony import */ var _data_grid_overlay_editor_style_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./data-grid-overlay-editor-style.js */ "../../node_modules/@glideapps/glide-data-grid/dist/esm/internal/data-grid-overlay-editor/data-grid-overlay-editor-style.js");
/* harmony import */ var _use_stay_on_screen_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./use-stay-on-screen.js */ "../../node_modules/@glideapps/glide-data-grid/dist/esm/internal/data-grid-overlay-editor/use-stay-on-screen.js");
...
const DataGridOverlayEditor = p => {
    ...
    const [isValid, setIsValid] = react__WEBPACK_IMPORTED_MODULE_0__.useState(() => {
        if (validateCell === undefined)
            return true;
        return !((0,_data_grid_data_grid_types_js__WEBPACK_IMPORTED_MODULE_4__.isEditableGridCell)(content) && validateCell?.(cell, content, lastValueRef.current) === false);
    });
    ...
    const setTempValue = react__WEBPACK_IMPORTED_MODULE_0__.useCallback((newVal) => {
        if (validateCell !== undefined && newVal !== undefined && (0,_data_grid_data_grid_types_js__WEBPACK_IMPORTED_MODULE_4__.isEditableGridCell)(newVal)) {
    ...
    const [editorProvider, useLabel] = react__WEBPACK_IMPORTED_MODULE_0__.useMemo(() => {
        if ((0,_data_grid_data_grid_types_js__WEBPACK_IMPORTED_MODULE_4__.isInnerOnlyCell)(content))
            return [];
    ...
    const { ref, style: stayOnScreenStyle } = (0,_use_stay_on_screen_js__WEBPACK_IMPORTED_MODULE_6__.useStayOnScreen)();
    let pad = true;
    let editor;
    let style = true;
    let styleOverride;
    ...
    return (0,react_dom__WEBPACK_IMPORTED_MODULE_1__.createPortal)(react__WEBPACK_IMPORTED_MODULE_0__.createElement(_common_styles_js__WEBPACK_IMPORTED_MODULE_3__.ThemeContext.Provider, { value: theme },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_click_outside_container_click_outside_container_js__WEBPACK_IMPORTED_MODULE_2__["default"], { style: (0,_common_styles_js__WEBPACK_IMPORTED_MODULE_3__.makeCSSStyle)(theme), className: className, onClickOutside: onClickOutside, isOutsideClick: isOutsideClick },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_data_grid_overlay_editor_style_js__WEBPACK_IMPORTED_MODULE_5__.DataGridOverlayEditorStyle, { ref: ref, id: id, className: classWrap, style: styleOverride, as: useLabel === true ? "label" : undefined, targetX: target.x - bloomX, targetY: target.y - bloomY, targetWidth: target.width + bloomX * 2, targetHeight: target.height + bloomY * 2 },
...
//# sourceMappingURL=node_modules_glideapps_glide-data-grid_dist_esm_internal_data-grid-overlay-editor_data-grid-o-c9572e.43aa520860572612ed53.js.map