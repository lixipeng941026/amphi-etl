...
/* ---------- Components ---------- */
const JobForm = ({ docManager, jobs, onSubmit, onCancel, initialValues }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.ConfigProvider, { theme: {
        ...
        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Form, { form: form, layout: "vertical", onFinish: onSubmit, initialValues: {
                schedule_type: "date",
                date_type: "once",
            ...
            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Form.Item, { style: { marginBottom: 16 }, name: "name", label: "\u4EFB\u52A1\u540D\u79F0", rules: [{ required: true, message: "请输入一个任务名称" }] },
                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Input, { placeholder: "\u6211\u7684\u4EFB\u52A1\u540D\u79F0" })),
            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Form.Item, { style: { marginBottom: 16 }, label: "\u7BA1\u9053\u8DEF\u5F84", required: true },
                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Space.Compact, { style: { width: "100%" } },
                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Form.Item, { name: "pipeline_path", noStyle: true, rules: [{ required: true, message: "请选择一个管道文件" }] },
                        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Input, { readOnly: true, placeholder: "\u9009\u62E9\u4E00\u4E2A .ampln \u6216 .py \u6587\u4EF6" })),
            ...
            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Form.Item, { style: { marginBottom: 16 }, name: "schedule_type", label: "\u8BA1\u5212\u7C7B\u578B" },
                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Radio.Group, { onChange: (e) => setScheduleType(e.target.value) },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Radio, { value: "trigger" }, "Trigger"))),
            scheduleType === "date" && (react__WEBPACK_IMPORTED_MODULE_4___default().createElement((react__WEBPACK_IMPORTED_MODULE_4___default().Fragment), null,
                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Form.Item, { style: { marginBottom: 16 }, name: "date_type", label: "\u65E5\u671F\u7C7B\u578B" },
                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Select, { onChange: (value) => setDateType(value), style: { width: "100%" } },
                        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Select.Option, { value: "once" }, "\u4E00\u6B21"),
                        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Select.Option, { value: "daily" }, "\u6BCF\u5929"),
                        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Select.Option, { value: "weekly" }, "\u6BCF\u5468"),
                        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Select.Option, { value: "monthly" }, "\u6BCF\u6708"),
                        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Select.Option, { value: "every_x_days" }, "\u6BCF\u9694 X \u5929"))),
                dateType !== "every_x_days" ? (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Form.Item, { style: { marginBottom: 16 }, name: "run_date", label: dateType === "once" ? "运行日期与时间" : "开始日期和时间", rules: [{ required: true, message: "请选择日期和时间" }] },
            ...
            scheduleType === "trigger" && (react__WEBPACK_IMPORTED_MODULE_4___default().createElement((react__WEBPACK_IMPORTED_MODULE_4___default().Fragment), null,
                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Form.Item, { style: { marginBottom: 16 }, name: "logical_operator", label: "Conditions Logic", rules: [{ required: true, message: "Please select AND or OR" }] },
                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Radio.Group, null,
                        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Radio, { value: "AND" }, "AND"),
                        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Radio, { value: "OR" }, "OR"))),
                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Form.List, { name: "trigger_conditions", rules: [
                        {
                    ...
                    ] }, (fields, { add, remove }, { errors }) => (react__WEBPACK_IMPORTED_MODULE_4___default().createElement((react__WEBPACK_IMPORTED_MODULE_4___default().Fragment), null,
                    fields.map((field) => (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Space, { key: field.key, style: { display: "flex", marginBottom: 12 }, align: "start" },
                        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Form.Item, { ...field, name: [field.name, "job_id"], rules: [{ required: true, message: "Select a task" }], style: { minWidth: 220 } },
                            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Select, { placeholder: "Task", showSearch: true, optionFilterProp: "label", options: jobs
                                    .filter((job) => job.id !== form.getFieldValue("id"))
                                    .map((job) => ({ value: job.id, label: job.name })) })),
                        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Form.Item, { ...field, name: [field.name, "on"], rules: [{ required: true, message: "Select outcome" }], style: { minWidth: 140 } },
                            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Select, { placeholder: "Outcome" },
                                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Select.Option, { value: "success" }, "Success"),
                                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Select.Option, { value: "failure" }, "Failure"))),
                        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Button, { type: "text", danger: true, onClick: () => remove(field.name) }, "Remove")))),
                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Form.ErrorList, { errors: errors }),
                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Button, { type: "dashed", onClick: () => add({ on: "success" }), icon: react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_5__.PlusOutlined, null), style: { width: "100%", marginBottom: 16 } }, "\u65B0\u589E\u6761\u4EF6")))))),
            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Form.Item, null,
                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Space, { style: {
                        marginBottom: 16,
                        width: "100%",
                        justifyContent: "flex-end",
                    } },
                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Button, { onClick: onCancel }, "\u53D6\u6D88"),
                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Button, { type: "primary", htmlType: "submit" }, "\u786E\u5B9A"))))));
};
...
const SchedulerPanel = ({ commands, docManager }) => {
    ...
    const [runs, setRuns] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)([]);
    const [loading, setLoading] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(false);
    const [monitoringLoading, setMonitoringLoading] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(false);
    ...
    const [activeTab, setActiveTab] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)("tasks");
    const [logsModalVisible, setLogsModalVisible] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(false);
    const [logsLoading, setLogsLoading] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(false);
    const [selectedRun, setSelectedRun] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(null);
    ...
    const fetchRuns = async (showLoader = false) => {
        ...
        try {
            ...
            _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.Notification.error("Failed to fetch run monitoring data");
        }
        finally {
            if (showLoader) {
    ...
    const getScheduleBadge = (job) => {
        if (job.schedule_type === "trigger")
            return { label: "Trigger", icon: react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_5__.ScheduleOutlined, null) };
        if (job.schedule_type === "interval")
            return { label: "Interval", icon: react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_5__.ClockCircleOutlined, null) };
        if (job.schedule_type === "cron")
            return { label: "Cron", icon: react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_5__.ScheduleOutlined, null) };
        return { label: "Date", icon: react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_5__.CalendarOutlined, null) };
    };
    const formatTriggerConditions = (job) => {
    ...
    const openRunLogs = async (run) => {
        ...
        try {
            ...
            _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.Notification.error("Failed to fetch run logs");
            setSelectedRun(run);
        }
        finally {
    ...
    const handleDeleteRun = (runId) => {
        ...
        _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.Notification.promise(promise, {
            ...
            error: {
                message: (err) => `Failed to remove monitoring entry: ${err instanceof Error ? err.message : String(err)}`,
            },
        });
    };
        ...
        _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.Notification.promise(promise, {
            ...
            success: {
                message: (_result, data) => {
                    var _a;
                    fetchRuns();
                    const deleted = (_a = data === null || data === void 0 ? void 0 : data.deleted) !== null && _a !== void 0 ? _a : 0;
                    return `Cleared ${deleted} monitoring entr${deleted === 1 ? "y" : "ies"}`;
                },
            },
            error: {
                message: (err) => `Failed to clear monitoring entries: ${err instanceof Error ? err.message : String(err)}`,
            },
        });
    };
    return (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.ConfigProvider, { theme: {
        ...
        react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", { className: styles.root },
            react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", { className: styles.content },
                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Tabs, { activeKey: activeTab, onChange: (key) => setActiveTab(key), items: [
                        {
                            key: "tasks",
                            label: "任务集",
                            children: (react__WEBPACK_IMPORTED_MODULE_4___default().createElement((react__WEBPACK_IMPORTED_MODULE_4___default().Fragment), null,
                                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Space, { style: { marginBottom: 12 } },
                                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Button, { type: "primary", icon: react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_5__.PlusOutlined, null), onClick: handleCreateJob }, "\u65B0\u4EFB\u52A1"),
                                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Button, { icon: react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_5__.ReloadOutlined, null), onClick: () => {
                                            fetchJobs();
                                            fetchRuns();
                                        } })),
                                loading ? (react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", { style: { textAlign: "center", padding: "40px 0" } },
                                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Spin, { size: "large" }))) : jobs.length === 0 ? (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Empty
                                // description="No scheduled tasks yet"
                                , { 
                                    // description="No scheduled tasks yet"
                                    description: "\u76EE\u524D\u8FD8\u6CA1\u6709\u5B89\u6392\u597D\u7684\u4EFB\u52A1", image: antd__WEBPACK_IMPORTED_MODULE_7__.Empty.PRESENTED_IMAGE_SIMPLE })) : (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.List, { itemLayout: "vertical", dataSource: jobs, renderItem: (job) => {
                                        ...
                                        return (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.List.Item, { key: job.id, actions: [
                                            ...
                                            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.List.Item.Meta, { title: react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Space, { wrap: true },
                                                    ...
                                                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Tag, { icon: badge.icon, color: "default" }, badge.label)), description: react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", null,
                                                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", { className: styles.jobMeta },
                                                        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_icons__WEBPACK_IMPORTED_MODULE_6__.pipelineBrandIcon.react, { className: styles.jobMetaIcon }),
                                                        react__WEBPACK_IMPORTED_MODULE_4___default().createElement("span", null,
                                                            "Pipeline: ",
                                                            job.pipeline_path)),
                                                    job.schedule_type !== "trigger" && job.next_run_time && (react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", { className: styles.jobMeta },
                                                    ...
                                                    job.schedule_type === "trigger" && !!triggerSummary && (react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", { className: styles.jobMeta },
                        ...
                        },
                        {
                            ...
                            children: (react__WEBPACK_IMPORTED_MODULE_4___default().createElement((react__WEBPACK_IMPORTED_MODULE_4___default().Fragment), null,
                                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Space, { style: { marginBottom: 12 } },
                                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Button, { danger: true, icon: react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_5__.DeleteOutlined, null), onClick: handleClearRuns }, "Clear"),
                                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Button, { icon: react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_5__.ReloadOutlined, null), onClick: () => fetchRuns() })),
                                monitoringLoading ? (react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", { style: { textAlign: "center", padding: "40px 0" } },
                                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Spin, { size: "large" }))) : runs.length === 0 ? (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Empty, { description: "No runs recorded yet", image: antd__WEBPACK_IMPORTED_MODULE_7__.Empty.PRESENTED_IMAGE_SIMPLE })) : (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.List, { itemLayout: "horizontal", dataSource: runs, renderItem: (run) => (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.List.Item, { key: run.id, actions: [
                                            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Tooltip, { title: "View logs", key: `logs-tooltip-${run.id}` },
                                                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Button, { key: `logs-${run.id}`, type: "text", icon: react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_5__.FileTextOutlined, null), onClick: () => openRunLogs(run) })),
                                            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Tooltip, { title: "Remove from monitoring", key: `remove-tooltip-${run.id}` },
                                                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Button, { key: `remove-${run.id}`, type: "text", danger: true, icon: react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_5__.CloseOutlined, null), onClick: () => handleDeleteRun(run.id) })),
                                        ] },
                                        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.List.Item.Meta, { title: react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Space, { wrap: true },
                                                react__WEBPACK_IMPORTED_MODULE_4___default().createElement("span", { style: { fontWeight: 600 } }, run.job_name || jobNameById.get(run.job_id || "") || run.job_id || "Unknown Task"),
                                                run.triggered_by === "manual" && react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Tag, { color: "default" }, "Manual"),
                                                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Tag, { icon: run.status === "success" ? react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_5__.CheckCircleOutlined, null) : react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_5__.CloseCircleOutlined, null), style: run.status === "success"
                                                        ? {
                                                            color: "#1f883d",
                                                            borderColor: "#1f883d",
                                                            background: "#eef8f2",
                                                        ...
                                                        : {
                                                            ...
                                                            borderColor: "#D1242F",
                                                            background: "#fff1f2",
                                                        } }, run.status === "success" ? "Succeeded" : "Failed")), description: `Time: ${dayjs__WEBPACK_IMPORTED_MODULE_9___default()(run.finished_at).format("YYYY-MM-DD HH:mm:ss")}` }))) })))),
                        },
                    ] })),
            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Modal, { title: currentJob ? "Edit Task" : "新建任务", open: jobModalVisible, onCancel: () => setJobModalVisible(false), footer: null, destroyOnClose: true, width: 500 },
                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(JobForm, { docManager: docManager, jobs: jobs, onSubmit: handleFormSubmit, onCancel: () => setJobModalVisible(false), initialValues: currentJob || undefined })),
            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Modal, { title: selectedRun ? `Run Logs - ${selectedRun.job_name || selectedRun.job_id || selectedRun.id}` : "Run Logs", open: logsModalVisible, onCancel: () => setLogsModalVisible(false), footer: null, width: 800, destroyOnClose: true }, logsLoading ? (react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", { style: { textAlign: "center", padding: "24px 0" } },
                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(antd__WEBPACK_IMPORTED_MODULE_7__.Spin, null))) : (react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", { style: { display: "flex", flexDirection: "column", gap: 12 } },
                react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", null,
                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement("strong", null, "Status:"),
                    " ",
                    (selectedRun === null || selectedRun === void 0 ? void 0 : selectedRun.status) === "success" ? "Succeeded" : "Failed",
                    " at",
                    " ",
                    (selectedRun === null || selectedRun === void 0 ? void 0 : selectedRun.finished_at) ? dayjs__WEBPACK_IMPORTED_MODULE_9___default()(selectedRun.finished_at).format("YYYY-MM-DD HH:mm:ss") : "n/a"),
                react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", null,
                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement("strong", null, "Output"),
                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement("pre", { style: {
                            maxHeight: 220,
                            overflow: "auto",
                            background: "#f6f8fa",
                            padding: 10,
                        } }, (selectedRun === null || selectedRun === void 0 ? void 0 : selectedRun.output) || "(no output)")),
                react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", null,
                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement("strong", null, "Error"),
                    react__WEBPACK_IMPORTED_MODULE_4___default().createElement("pre", { style: {
                            maxHeight: 220,
                            overflow: "auto",
                            background: "#fff2f0",
                            padding: 10,
                        } }, (selectedRun === null || selectedRun === void 0 ? void 0 : selectedRun.error) || "(no error)"))))))));
};
/* ---------- plugin ---------- */
var CommandIDs;
(function (CommandIDs) {
...
const plugin = {
    ...
    autoStart: true,
    requires: [_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ICommandPalette, _jupyterlab_docmanager__WEBPACK_IMPORTED_MODULE_3__.IDocumentManager] /* UPDATED */,
    activate: (app, palette, docManager) => {
        ...
        commands.addCommand(CommandIDs.open, {
            ...
            execute: () => {
                ...
                const ENABLE_SCHEDULER = false;
                if (ENABLE_SCHEDULER && !widget.isAttached)
...
//# sourceMappingURL=lib_index_js.55c60bc3974d138dd6be.js.map