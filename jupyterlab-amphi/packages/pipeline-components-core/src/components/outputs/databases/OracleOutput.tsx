...
export class OracleOutput extends BaseCoreComponent {
  constructor() {
    ...
    const form = {
      ...
      fields: [
        ...
        },
        {
          ...
          tooltip:
            "Specify the directory of the desired Oracle client if needed.",
          id: "oracleClient",
    ...
    const description =
      "Use Oracle Output to insert data into an Oracle database table by specifying a data mapping between the incoming data and the existing table schema.";
