...
export class ODBCInput extends BaseCoreComponent {
  constructor() {
      ...
      fields: [
        {
          ...
          tooltip:
            "Provide the full ODBC connection string for your database. Reference: https://github.com/mkleehammer/pyodbc/wiki/Connecting-to-databases",
          connection: "ODBC",
          advanced: true,
        },
        {
    ...
    const description =
      "Use ODBC Input to retrieve data from various databases using an ODBC connection string, along with either a table name or a custom SQL query.";
...
conn = pyodbc.connect(f"""${connectionString}""", autocommit=${
