...
export class BigQueryInput extends BaseCoreComponent {
  constructor() {
      ...
      fields: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              tooltip: "You will be prompted to login via the browser.",
            },
          ],
        ...
        },
        {
          ...
          id: "sqlQuery",
          tooltip:
            "Optional. By default, the SQL query is: SELECT * FROM dataset.table_name_provided. If specified, the SQL Query is used.",
    ...
    const description =
      "Use BigQuery Input to retrieve data from Google BigQuery by specifying either a table name or a custom SQL query.";
...
`;
      ...
      throw new Error(
        "Unsupported connection method: " + config.connectionMethod,
      );
    }
